...
namespace KeycloakIdentityModel
{
    public class KeycloakIdentity : ClaimsIdentity, IIdentity
    {
        ...
        /// </summary>
        public override string AuthenticationType => _parameters.AuthenticationScheme;
        ...
        /// <returns></returns>
        public static async Task<KeycloakIdentity> ConvertFromJwtAsync(IKeycloakParameters parameters, string accessToken, string refreshToken = null, string idToken = null)
        {
            if (parameters == null) throw new ArgumentNullException(nameof(parameters));
        ...
        /// <returns></returns>
        public static async Task<Uri> GenerateLogoutUriAsync(IKeycloakParameters parameters, Uri baseUri, string redirectUrl = null)
        {
            if (parameters == null) throw new ArgumentNullException(nameof(parameters));
            if (baseUri == null) throw new ArgumentNullException(nameof(baseUri));
        ...
        {
            // Add generic claims
            yield return new Claim(Constants.ClaimTypes.AuthenticationType, _parameters.AuthenticationScheme);
