...
{
    public class KeycloakAuthenticationOptions : AuthenticationOptions, IKeycloakParameters, IOptions<KeycloakAuthenticationOptions>
    {
        ...
        ///     - Default: Null
        /// </remarks>
        public string SignInAsAuthenticationSchema { get; set; }
        ...
        public KeycloakAuthenticationOptions Value => this;
    }
}
